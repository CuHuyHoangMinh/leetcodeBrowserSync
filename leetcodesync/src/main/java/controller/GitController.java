...
//		}
	...
	public boolean addReadMe() throws IOException, JSONException {
		// add readme content
		String readme = "";
		return addFiles("README.md", readme, "add README.md");
	}
...
//	public boolean addFilesById(String path, String fileId, String fileContent, String commitMessage)throws IOException, JSONException { 
//		
//		return false;
//	}

	public boolean addFiles(String path, String fileContent, String commitMessage) throws IOException, JSONException {
		HttpUrl url = new HttpUrl.Builder() //
				.scheme(PROTOCOL) //
				.host(GIT_URL) //
				.addPathSegment("repos") //
		...
		JSONObject jsonRequestBody = new JSONObject();
		jsonRequestBody.put("message", commitMessage);
		jsonRequestBody.put("content", Base64.getEncoder().encodeToString(fileContent.getBytes()));
		RequestBody body = RequestBody.create(jsonRequestBody.toString(), MediaType.parse("application/json"));
